...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.PwExpiraTime = field.NewTime(tableName, "pw_expira_time")
...
func (u *user) updateTableName(table string) *user {
	...
	u.PwExpiraTime = field.NewTime(table, "pw_expira_time")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["pw_expira_time"] = u.PwExpiraTime
}
